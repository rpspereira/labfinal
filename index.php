...
<head>
    ...
    <style>
        ...
        input[type="text"], input[type="number"], textarea { padding: 8px; margin: 5px; border: 1px solid #ccc; border-radius: 4px; width: 150px; }
        textarea { resize: vertical; height: 60px; width: 200px; }
        button { padding: 10px 15px; margin: 5px; cursor: pointer; background: #3498db; color: white; border: none; border-radius: 4px; }
        button:hover { background: #2980b9; }
        .remove-btn { background: #e74c3c; color: white; text-decoration: none; padding: 5px 10px; border-radius: 3px; margin-left: 5px; }
